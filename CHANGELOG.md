...
### Added
- `delete_container` MCP tool — removes a registry entry (does not touch the actual container). For retiring stale/recycled CTID registrations, e.g. a deprecated pseudo-CTID migrated to the machine registry. Instant, idempotent-hint.
